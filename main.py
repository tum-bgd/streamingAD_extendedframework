...
def main(dataset_category: str, collection_id: str, dataset_id: str) -> None:
    ...
    dataset_base_path = f'./data/{dataset_category}/{collection_id}/{dataset_id}'
    ...
    #     [
    #         dataset_test, 
    #         np.random.normal(loc=np.mean(dataset_test), scale=np.std(dataset_test), size=dataset_test.shape)
    #     ], axis=-1)
    # dataset_train = np.concatenate(
    #     [
    #         dataset_train, 
    #         np.random.normal(loc=np.mean(dataset_train), scale=np.std(dataset_train), size=dataset_train.shape)
    #     ], axis=-1)
